      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar" style="background-color: #230A59">
          <ul class="nav nav-sidebar">
			...
			<li><a href="user.php"><i class="icon-key"></i> Users</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="roomdetail">
		  ...
		  <button type="button" class="btn" id="addroom" style="width: 100px; background-color: #4aa3df; color: white;" type="button">Add Room</button>
        </div>
					...
					<form role="form" id="formnew" action="addroom.php" method="post" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
						...
						<input type="text" class="form-control" name="occupancy" id="occupancy" placeholder="max number of occupants">
					  </div>
					  <div class="form-group">
						<label for="size">Size</label>
						<input type="text" class="form-control"  name="size" id="size" placeholder="Example: 10 sqm">
					  </div>
					  <div class="form-group">
						<label for="view">View</label>
						<input type="text" class="form-control" name="view" id="view" placeholder="example: city">
					  </div>
					  <div class="form-group">
						<label for="rate">Rate</label>
						<input type="text" class="form-control"  nsme="rate" id="rate" placeholder="Write without EUR" required>
					  </div>
					  <div class="form-group">
					  ...
					  <button type="submit" class="btn btn-default" style="width: 100px; background-color: #4aa3df; color: white;">Submit</button>
					</form>
		</div>
