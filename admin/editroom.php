  ...
  <body style="background-color: #5C73F2;">
    ...
    <div class="container-fluid">
      <div class="row">
		...
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		print "						<label for=\"total_room\">Total Rooms</label>\n";
		...
		print "						<input type=\"text\" class=\"form-control\"  name=\"size\" id=\"size\" placeholder=\"Please write sqm \" value=\"".$rows['size']."\">\n";
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		...
		print "						<input type=\"text\" class=\"form-control\"  name=\"rate\" id=\"rate\" placeholder=\"Write without EUR\" value=\"".$rows['rate']."\" required>\n";
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		...
		print "					  </div>\n";
		print "					  <button type=\"submit\" class=\"btn btn-default\" style=\"width: 200px; background-color: #4aa3df; color: white;\" >Update Room Detail</button>\n";
		print "					</form>";		
