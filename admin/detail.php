    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main bookinginfo">
		  ...
		  <button type="button" class="btn" id="editbook" style="width: 100px; background-color: #4aa3df; color: white;" type="button">Edit Booking</button>
        </div>
		
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main editbooking" style="display:none">
			 <button type="button" class="btn" id="back" style="width: 100px; background-color: #4aa3df; color: white;">Back</button><hr>
				 <form  role="form" action="updatebooking.php" method="post">
						...
						if(mysqli_num_rows($r)>0){
							...
							{
print "							<label for=\"paymentstatus\">Arrival Status</label>\n";
...
print "						<hr><label for=\"telephone\">Telephone</label>	<input type=\"text\" class=\"form-control\" name=\"telephone\" id=\"telephone\" placeholder=\"Phone No.\" value=\"".$rows['telephone_no']."\">";
				  ...
				  <hr><button type="submit" class="btn btn-default" style="width: 100px; background-color: #4aa3df; color: white;">Update</button>
				</form>
		</div>
      </div>
    </div>
