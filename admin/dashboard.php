...
function more3()
			 ...
			 <h4 class="sub-header">Dashboard</h4>
				<div class="row">	
					...
					if(mysqli_num_rows($re) > 0)
					{
						...
						echo "                                    </h3>\n";
						echo "                                    <p>\n";
						echo "                                        New Bookings in Last 7 days\n";
						echo "                                    </p>\n";
						echo "                                </div>\n";
						echo "                                <div class=\"icon\">\n";
					...
					if(mysqli_num_rows($re2) > 0)
					{
						...
						echo "                                    </h3>\n";
						echo "                                    <p>\n";
						echo "                                        Bookings with Pending Arrival\n";
						echo "                                    </p>\n";
						echo "                                </div>\n";
						echo "                                <div class=\"icon\">\n";
						echo "                                    <i class=\"ion ion-person-add\"></i>\n";
					...
					if(mysqli_num_rows($re3) > 0)
					{
						...
						echo "                                    </h3>\n";
						echo "                                    <p>\n";
						echo "                                        Bookings with Completed Arrival\n";
						echo "                                    </p>\n";
						echo "                                </div>\n";
						echo "                                <div class=\"icon\">\n";
						echo "                                    <i class=\"ion ion-person-add\"></i>\n";
  ...
  <script>
		new Morris.Line({
		  ...
		  <?php
					include './auth.php';
					$re = mysqli_query("select MONTH(booking_date) as month, YEAR(booking_date) as year, count(booking_date) as value from booking group by MONTH(booking_date);");
