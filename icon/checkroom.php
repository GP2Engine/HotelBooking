				...
				if(mysqli_num_rows($result) > 0){
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						if($row['availableroom'] != null && $row['availableroom'] > 0  )
						{
							...
							$sub_result = mysqli_query("select room.* from room where room.room_id = ".$row['room_id']." ");
							...
							$sub_result2 = mysqli_query("select room.* from room where room.room_id = ".$row['room_id']." ");
