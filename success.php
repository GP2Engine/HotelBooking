...
$r = mysqli_query("UPDATE  `booking` SET  `payment_status` =  'confirmed' WHERE  `booking`.`booking_id` = ".$id.";");
echo mysqli_error();
$result = mysqli_query("select * from booking where booking_id = '".$id."';");
