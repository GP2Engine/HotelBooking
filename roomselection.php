	...
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<p><b>Your Reservation</b></p><hr>
				...
				<div class="row">
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<button name="submit" href="#" class="button small fontslabo" style="background-color:#5C73F2; width:100%;" >Edit Reservation</button>
					</div>
				  </div>
				</form>
		</div>
		...
		<p><b>Choose Your Room</b></p><hr>
				<form class="form1" action="index.php" method="post" onsubmit="return validateForm()">
					...
					<div class="row">
						...
						<div class="large-4 columns">
						<p ><span class="fontgrey">Rate : EUR </span><span style="font-size:24px;">180</span><span class="fontgrey">/ night</span><br>
						<span style="text-align:right;">6 room available</span>
							...
							<div class="row">
								...
								<div class="large-6 columns">
									<button type="submit"  class="book button small" style="background-color:#5C73F2; width:100%; height:45px; !important;" onchange="validateClick(this);">Book</button>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<span style="text-align:right;">6 room available</span>
							...
							<div class="row">
								...
								<div class="large-6 columns">
									<button type="submit" id="room7" class="book button small" style="background-color:#5C73F2; width:100%; height:45px; !important;" onclick="validateClick(this);">Book</button>
								</div>
							</div>
						</div>
