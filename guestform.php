...
<div class="large-12 columns" style="padding-top: 20px; background-color: #230A59;">
		...
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round fontslabo" style="background-color:#5C73F2;">3</a>
...
<div class="row">
	...
	<div class="large-8 columns blackblur fontcolor" style="padding-top:10px; background-color: #230A59;">
		...
		<form action="insertandemail.php" method="post"  onSubmit="return validateForm(this);">
		  ...
		  <div class="row">
			<div class="large-12 columns" style="text-align:right;"><button type="submit" class="button small fontslabo" style="background-color:#5C73F2;" onclick="return confirm('Are you sure you want to continue?')" >Confirm</button>
		  </div>
