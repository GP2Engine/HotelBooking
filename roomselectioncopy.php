	...
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<p><b>Check Date</b></p><hr>
				...
				<div class="row">
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<button name="submit" href="#" class="button small fontslabo" style="background-color:#5C73F2; width:100%;" >Check Availability</button>
					</div>
				  </div>
				</form>
		</div>
					...
					<div class="row">
						...
						<span style="text-align:right;">6 room available</span>
							...
							<div class="row">
								...
								<div class="large-6 columns">
									<button type="submit" id="button.room_id" class="button small" style="background-color:#5C73F2; width:100%; height:45px; !important;" >Book</button>
								</div>
							</div>
						</div>
