...
This is normal HTML code
	...
	$result = mysqli_query("select * from Room where room.room_id in 
		  (
	...
	while ($row = mysqli_fetch_array($result)) {
	   echo "<br>room_id:".$row{'room_id'}." Room_type:".$row{'bed_type'}."Occupany: ".$row{'occupancy'}."<br>"; //display the results
		...
		print "					<button type=\"button\" href=\"#\" class=\"button small selectroom fontslabo\" style=\"background-color:#5C73F2;\"  value=\"".$row{'room_id'}."\">Select Room</button>\n";
		print "					\n";
		print "				</div>\n";
		print "			</div><hr>";
