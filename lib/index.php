...
<html class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths" lang="en" data-useragent="Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.111 Safari/537.36"><link rel="icon" href="img/icon.png"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta charset="utf-8">
...
<div class="large-12 columns">
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round blackblur font" style="background-color:#5C73F2;">1</a>
		</div>
		<div class="large-3 columns centerdiv">
...
<div class="row">
	...
	<p><b>Check Date</b></p><hr>
			...
			<br><br>
			  <div class="row">
				<div class="large-12 columns" >
					<button type="submit" href="#" class="button small" style="background-color:#5C73F2;" >Check Availability</button>
				</div>
			  </div>
			</form>
	</div>
