...
<div class="large-12 columns" style="padding-top: 20px; background-color: #230A59;">
		...
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round fontslabo" style="background-color:#5C73F2;">2</a>
...
<div class="row">
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px; background-color: #230A59;">
		...
		<p><b>Your Reservation</b></p>
					...
					<div class="large-12 columns">
						<div class="row">
							...
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgrey">Arrival Date
								</span>
							</div>
						...
						<div class="row">
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgrey">Departure Date
								</span>
							</div>
						...
						<div class="row">
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgrey">Number of Adults
								</span>
							</div>
						...
						<div class="row">
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgrey">Number of Kids
								</span>
							</div>
						...
						<div class="row">
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgrey" style="font-size:13.2px;">Total overnight stays
								</span>
							</div>
				...
				<div class="row">
					<div class="large-12 columns" >
						<br><button name="submit" href="#" class="button small fontslabo" style="background-color:#5C73F2; width:100%;">Edit Reservation</button>
					</div>
				</div>
				</form>
		...
		<div class="large-12 columns" id="roomselected" style="display:none;" >
				<hr>
							<br><label for="submit-form" class="book button small fontslabo" style="background-color:#5C73F2; width:100%; height:45px; !important;">Proceed To Book</label><!--button name="submit" href="#" class="button small fontslabo" style="background-color:#5C73F2; width:100%;" >Proceed Booking</button-->
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						if($row['availableroom'] != null && $row['availableroom'] > 0  )
						{
							...
							if(mysqli_num_rows($sub_result) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : EUR </span><span style=\"font-size:24px;\">".$sub_row['rate']."</span><span class=\"fontgrey\">/ night</span><br>\n";
							...
							if(mysqli_num_rows($sub_result2) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : EUR </span><span style=\"font-size:24px;\">".$sub_row2['rate']."</span><span class=\"fontgrey\">/ night</span><br>\n";
								...
								//print "				<button type=\"submit\"  class=\"book button small\" style=\"background-color:#5C73F2; width:100%; height:45px; !important;\" >Book</button>\n";	
								print "								</div>\n";
								print "							</div>\n";
								print "						</div>\n";
								print "						\n";
